...
const Add = ({token}) => {
  ...
  const onSubmitHandler = async(e) => {
     ...
     try{
        ...
        formData.append('sizes',JSON.stringify(sizes));//can't store array in formData. so convert string
          ...
          <div>
            ...
            <div className='flex gap-3'>
              ...
              <div onClick={()=>setSizes(prev=>prev.includes('L') ? prev.filter(item=>item !== 'L') : [...prev,'L'])}>
                <p className={`${sizes.includes('L') ? 'bg-pink-100' : 'bg-slate-200'} px-3 py-1 cursor-pointer`}r>L</p>
              </div>
